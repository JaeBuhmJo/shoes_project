<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <!-- Start Contact -->
        ...
        <div class="row py-5">
            <form class="col-md-9 m-auto" id="qnaForm" method="post" role="form">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control mt-1" id="question" name="question" placeholder="question" rows="8">
                ...
                <div class="row">
                    <div class="col text-end mt-2">
                        ...
                        <button type="submit" class="btn btn-danger btn-lg px-3">취소</button>
                    </div>
                </div>
            </form>
        </div>
	...
	<input type="hidden" name="page" value="${member.memberId}" />
