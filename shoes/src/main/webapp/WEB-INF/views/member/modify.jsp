  ...
  <div class="row py-5">
    <form class="col-md-9 m-auto" method="post" role="form">
      ...
      <div class="form-group mb-3">
        ...
        <input type="text" class="form-control mt-1" id="name" name="name" placeholder="이름" value="${userDetails.name }" required>
      </div>
      <div class="form-group mb-3">
      ...
      <div class="form-group mb-3">
        ...
        <input type="password" class="form-control mt-1" id="password" name="newPassword" placeholder="비밀번호"  required>
      </div>
      <div class="form-group mb-3">
        <label for="password">재확인 비밀번호</label>
        <input type="password" class="form-control mt-1" id="password" name="confirmPassword" placeholder="비밀번호"  required>
      </div> 
      <div class="form-group mb-3">
        <label for="phone">휴대폰</label>
        <input type="text" class="form-control mt-1" id="phone" name="phone" placeholder="휴대폰" value="${userDetails.phone }" required>
      </div>
      <div class="form-group mb-3">
        <label for="address">주소</label>
        <input type="text" class="form-control mt-1" id="address" name="address" placeholder="주소" value="${userDetails.address }" required>
      </div>
      <div class="form-group mb-3">
        <label for="email">이메일</label>
        <input type="email" class="form-control mt-1" id="email" name="email" placeholder="이메일"value="${userDetails.email }" required>
      </div>
      <div class="form-group mb-3">
        <label for="footSize">발사이즈</label>
        <input type="text" class="form-control mt-1" id="footSize" name="footSize" placeholder="발사이즈"value="${userDetails.footSize }" required>
      </div>
      <div class="row">
